        ...
        nodes_along_path.append(
            {
                ...
                "inclusions": child_node.get("inclusions", ""),
                "exclusions": child_node.get("exclusions", ""),
                "decision_rule": child_node.get("decision_rule", ""),
                "comprehensive_definition": child_node.get("comprehensive_definition", ""),
            }
        )
        node = child_node
